...
def training_data(configuration):
    ...
    output_column = "Severity_Level"  # For multiple classifications
    ...
    if num_labels == 2:
        ...
        label_list = custom_sort(label_list)
    ...
    def speech_file_to_array_fn(path):
        try:
            ...
            if speech_array.numel() == 0:
                print(f"Empty audio file detected: {path}")
...
if __name__ == '__main__':
    ...
    train_dataset, eval_dataset = preprocess_data(
        configuration, processor, target_sampling_rate,
        train_dataset, eval_dataset, input_column, output_column, label_list
    )
