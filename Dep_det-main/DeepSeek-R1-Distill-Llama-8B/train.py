...
OUTPUT_DIR = "/workspace/8bllama/models"
CHECKPOINT_DIR = "/workspace/8bllama/models/checkpoint-500"  
...
class TrainingConfig(TrainingArguments):
    ...
    per_device_train_batch_size: int = field(default=48) 
    per_device_eval_batch_size: int = field(default=48)  
